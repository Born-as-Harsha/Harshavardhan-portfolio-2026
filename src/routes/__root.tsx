  ...
  head: () => ({
    meta: [
      ...
      { title: "Yelleti Harshavardhan — VLSI & Semiconductor Engineer" },
      {
        name: "description",
        content:
          "Portfolio of Yelleti Harshavardhan — B.Tech ECE undergraduate at KLEF specializing in VLSI, RTL, FPGA and ASIC design. CGPA 9.68.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/7aac1121-42f4-4eb5-af8e-94617c8b4ea3",
      },
      {
        name: "twitter:image",
        content:
