...
export const PROJECTS = [
  { title: "4-bit ALU in Verilog", tag: "RTL · FPGA", tech: ["Verilog", "ModelSim", "Vivado"], description: "Designed and verified a 4-bit Arithmetic Logic Unit supporting arithmetic and logical operations, simulated with testbenches and synthesized on FPGA.", highlights: ["8 ALU operations", "Full testbench coverage", "RTL → synthesis flow"] },
  { title: "32-bit RISC Processor (Pipelined)", tag: "Computer Architecture", tech: ["Verilog", "Vivado", "FPGA"], description: "RTL implementation of a 5-stage pipelined RISC processor with hazard detection and forwarding, written in Verilog and verified on FPGA.", highlights: ["5-stage pipeline", "Hazard handling", "Single-cycle ISA subset"] },
  { title: "UART Communication Protocol", tag: "Digital Design", tech: ["Verilog", "FPGA", "Serial I/O"], description: "Full-duplex UART transmitter and receiver in Verilog with configurable baud rate, parity and framing — synthesized and tested on FPGA.", highlights: ["Configurable baud", "TX/RX FSMs", "Parity & framing checks"] },
  { title: "FIR Digital Filter on FPGA", tag: "DSP · FPGA", tech: ["Verilog", "MATLAB", "Vivado"], description: "Parameterised FIR filter implemented in Verilog targeting Xilinx FPGA, with MATLAB-generated coefficients and waveform verification.", highlights: ["Parameterised taps", "MATLAB co-design", "On-board verification"] },
  { title: "Smart Traffic Light Controller", tag: "FSM · Embedded", tech: ["Verilog", "FSM", "FPGA"], description: "FSM-based traffic light controller modelled in Verilog with timing logic and emergency override, prototyped on FPGA dev-board.", highlights: ["Mealy/Moore FSM", "Emergency mode", "Real-time waveform"] },
  { title: "DC Analysis & Short Channel Effects in MOSFETs", tag: "Analog VLSI", tech: ["NI Multisim", "LTspice"], description: "Analyzed NMOS and PMOS transistor characteristics including short-channel effects and channel length modulation.", highlights: ["I_D-V_GS / I_D-V_DS plots", "Short-channel analysis", "Device-level insight"] },
  ...
  { title: "Activity & Achievement Tracker", tag: "Full Stack", tech: ["Python", "Web"], description: "Web-based system to manage student extracurricular activities and achievements with full-stack Python concepts.", highlights: ["CRUD workflows", "Activity tracking", "Data management"] },
];
